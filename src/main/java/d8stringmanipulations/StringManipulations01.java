...
public class StringManipulations01 {
    public static void main(String[] args) {
        ...
        System.out.println(sub4); //easy, başlangıç sayısını yazdığımızda kendisi sonuna kadar otomatik olarak gidiyor.
        ...
        System.out.println(isExist); //true, easy kelimesindeki "e" harfini büyük yazsaydık hata verecekti.
