...
public class Maps01 {
    public static void main(String[] args) {
        ...
        //ogrenciNotlari.put("Ahmet", null); HATA //NullPointerException

        HashMap<String, Integer> stdAges = new HashMap<>();
        stdAges.put("Ali", 18);
        stdAges.put("Ahmet", 41);
        stdAges.put(null,41); //{null=41, Ahmet=41, Ali=18}
        stdAges.put(null,39); //{null=39, Ahmet=41, Ali=18} - key bolumunda tek null olur, uzerine yazdi
        stdAges.put("a",null); //{null=39, Ahmet=41, a=null, Ali=18}
        stdAges.put("b",null); //{null=39, Ahmet=41, a=null, b=null, Ali=18} - value kısmında istedigimiz kadar null koyabiliriz
        ...
        //countryPopulation.put(null,18000000); HATA - NullPointerException
        countryPopulation.put("Italy", null); //yazdirir
        countryPopulation.put("France", null); //yazdirir
