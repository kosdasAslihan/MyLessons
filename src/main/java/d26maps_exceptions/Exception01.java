...
public class Exception01 {
    public static void main(String[] args) {
        ...
        //bolme(5,0); ArithmeticException: / by zero
        //bolme(5,0); Lutfen 0 girmeyiniz
        //bolme2(7,0); //Lutfen sifira bolme islemi yapmayiniz
        //bolme2(7,0); //Lutfen sifira bolme islemi yapmayiniz //try catch sonrasi kod, akisina devam ediyor
        bolme2(7,2); //3 //try ici gorev tamamlandi //try catch sonrasi kod, akisina devam ediyor
    ...
    public static void bolme2(int a, int b){
        try {
            ...
            //System.out.println(0); 0'i da bu sekilde kabul edebiliriz
