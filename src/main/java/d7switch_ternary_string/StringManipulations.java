...
public class StringManipulations {
    public static void main(String[] args) {
        ...
        String s = "Java is easyad";

        //length() methodu String’in uzunlugunu dondurur.1’den baslar

        int sLenght = s.length();
        System.out.println(sLenght); //12 System.out.println(s.length());
        ...
        char lastChar2 = s.charAt(s.length()-1); //Dynamic Code, en sondaki harfi verir
