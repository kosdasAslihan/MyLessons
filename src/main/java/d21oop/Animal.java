...
public class Animal { //public final class Animal ==> Animal'in child'i class olmaz
    ...
    */
    ...
    //ornegin; pi sayisini farkli bir method icind yine kullanabilirsiniz.
    ...
    public Animal create() { //Animal burada data type'dir.
        ...
        return new Animal(); //yeni bir Animal objesi urettim ve onu disari Animal data type'i ile return ettim
    }
