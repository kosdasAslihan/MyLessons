...
public class ArrayList01 {
    public static void main(String[] args) {
        ...
        */
        ...
        ages.add(1, 28);
        System.out.println(ages); //[9, 28, 12, 5] 1. index'tekini saga iteleyip araya 28 yazdi
        ...
        ages.add(11); //ages.add(5,11), her eklenen en sona eklendigi icin index belirtmeye gerek yok
        ...
        ages.addAll(newAges);
        System.out.println(ages); //[9, 28, 12, 7, 5, 11, 1, 2, 3] sagdakini sola atadi.
