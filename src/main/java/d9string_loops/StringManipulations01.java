...
public class StringManipulations01 {
    public static void main(String[] args) {
        ...
        //burda abc@gmail.com'a ekleme yaptigimizda almak istedigimiz deger kayar

        //2.yol: Dinamik
        String company1 = a.split("@")[1].split("\\.")[0];
        System.out.println(company1); //gmail
        //boldugumuz zaman abc kismi [0], gmail.com kismi [1] seklinde bolunur.
        //2. bolumde ise gmail kismi [0], com kismi [1] seklinde olur.
        //Java'da . herhangi bir anlamina geldigi icin nokta olarak algilayabilmesi icin \\. seklinde yaptik.
