...
public class Sets01 {
    public static void main(String[] args) {
        ...
        System.out.println(hs); //[Kerem, Sinan, Tuba, Onur] tekrarli eleman hata vermez, tekrarli elemanin uzerine yazar
        ...
        System.out.println(hs3); //[Hasan, Fatma] //Bu set degistirilemez, kisitlama vardir.
        //Yeni eleman eklenemez, mevcut elemanlar cikartilamaz.
        ...
        //ts.add(null); HATA-neden null ekleyemiyoruz cunku dogal siralamaya engel oluyor
        ...
        System.out.println(ss); //[G, R] G dahil U'ya kadar olan elemanlari verdi, U dahil degil
