...
public class Queue01 {
    public static void main(String[] args) {
        ...
        //System.out.println(depo.clear()); HATA (alti kirmizi cizgi oluyor)
        depo.clear();
        ...
        //System.out.println(depo.element()); HATA, cunku clear methodu ile depeoyu bosaltmistik
        ...
        for (String w : d){
            System.out.println(w); //Alt alta yazdirmis olduk
        }
        System.out.println("----------------");
        ...
        //----------------------------------------------------------
        //ArrayDeque Java’da çift yönlü kuyruk (double-ended queue) yapısını
        //temsil eder (verilerini bir dizi (array) içinde saklar) ve Deque arayüzünü uygular.
